...
class HXCPP_CLASS_ATTRIBUTES  PluginFrontEnd_obj : public hx::Object{
	...
	public:
		...
		virtual ::flixel::plugin::MouseEventManager add_flixel_plugin_MouseEventManager( ::flixel::plugin::MouseEventManager Plugin);
		Dynamic add_flixel_plugin_MouseEventManager_dyn();
