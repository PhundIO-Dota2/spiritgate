...
::flixel::plugin::MouseEventManager PluginFrontEnd_obj::add_flixel_plugin_MouseEventManager( ::flixel::plugin::MouseEventManager Plugin){
	HX_STACK_FRAME("flixel.system.frontEnds.PluginFrontEnd","add_flixel_plugin_MouseEventManager",0xeeeda7c2,"flixel.system.frontEnds.PluginFrontEnd.add_flixel_plugin_MouseEventManager","flixel/system/frontEnds/PluginFrontEnd.hx",28,0xbff70e9e)
	HX_STACK_THIS(this)
		...
		while((true)){
			...
			HX_STACK_LINE(32)
			{
				...
				HX_STACK_LINE(32)
				{
					...
					HX_STACK_LINE(32)
					::flixel::plugin::MouseEventManager tmp5 = Plugin;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(32)
					...
					if ((tmp6)){
						...
						HX_STACK_LINE(32)
						::flixel::plugin::MouseEventManager tmp7 = Plugin;		HX_STACK_VAR(tmp7,"tmp7");
						HX_STACK_LINE(32)
			...
			if ((tmp3)){
				HX_STACK_LINE(34)
				::flixel::plugin::MouseEventManager tmp4 = Plugin;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(34)
				return tmp4;
			}
		}
	...
	HX_STACK_LINE(39)
	::flixel::plugin::MouseEventManager tmp = Plugin;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(39)
	this->list->__Field(HX_HCSTRING("push","\xda","\x11","\x61","\x4a"), hx::paccDynamic )(tmp);
	HX_STACK_LINE(40)
	::flixel::plugin::MouseEventManager tmp1 = Plugin;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(40)
	return tmp1;
}


HX_DEFINE_DYNAMIC_FUNC1(PluginFrontEnd_obj,add_flixel_plugin_MouseEventManager,return )
...
Dynamic PluginFrontEnd_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 30:
		...
		break;
	case 35:
		if (HX_FIELD_EQ(inName,"add_flixel_plugin_MouseEventManager") ) { return add_flixel_plugin_MouseEventManager_dyn(); }
	}
...
static ::String sMemberFields[] = {
	HX_HCSTRING("add_flixel_plugin_MouseEventManager","\x71","\xd1","\xc0","\x01"),
