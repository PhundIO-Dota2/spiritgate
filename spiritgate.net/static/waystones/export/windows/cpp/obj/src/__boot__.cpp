...
::flixel::plugin::_MouseEventManager::ObjectMouseData_obj::__register();
::flixel::plugin::MouseEventManager_obj::__register();
...
::DraggableWaystone_obj::__register();
