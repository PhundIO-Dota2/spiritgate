...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "waystones", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "waystones";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "waystones", null, { width: 900, height: 900 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 900, height: 900 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 900, 900, "null");
		#end
		#else
		create ();
		#end
