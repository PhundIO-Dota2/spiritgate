...
XP_PER_LEVEL_TABLE[2] = 350
local increase = 330
for i = 3, MAX_LEVEL do
	XP_PER_LEVEL_TABLE[i] = XP_PER_LEVEL_TABLE[i - 1] + increase
...
TEAM_COLORS[DOTA_TEAM_GOODGUYS] = { 80, 80, 255 }--{ 61, 210, 150 }  --    Teal
TEAM_COLORS[DOTA_TEAM_BADGUYS]  = { 255, 80, 80 }--{ 243, 201, 9 }   --    Yellow
